...
This document contains the requirements for the NuGet Installer project.

## Purpose

NuGet Installer is a reference implementation demonstrating best practices for DEMA Consulting
