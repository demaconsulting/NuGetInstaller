...
We take the security of NuGet Installer seriously. If you believe you have found a
...
When using NuGet Installer, we recommend following these security best practices:

### Input Validation

- Validate command-line arguments and file paths before processing
- Be cautious when processing data from untrusted sources
- Use the latest version of NuGet Installer to benefit from security updates

### Dependencies

- Keep NuGet Installer and its dependencies up to date
...
- Run NuGet Installer with the minimum required permissions
- Avoid running NuGet Installer as a privileged user unless necessary
...
NuGet Installer reads and writes files on the local file system. Users should:
...
NuGet Installer relies on third-party packages. We:
...
Thank you for helping keep NuGet Installer and its users safe!

[security-advisories]: https://github.com/demaconsulting/NuGetInstaller/security/advisories
